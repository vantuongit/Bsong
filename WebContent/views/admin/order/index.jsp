                        ...
                        <div class="table-responsive">
                          ...
                          <div class="alert alert-warning" role="alert">
                           ...
                           <%} %>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                if(categories != null && categories.size()>0 ){
                                	for(Category category :categories){
                                		...
                                		String phone = category.getName();
                                		String address = category.getName();
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="<%=urlEdit %>" title="xem" class="btn btn-primary"><i class="fa fa-edit "></i> Xem</a>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_info" id="dataTables-example_info" style="margin-top:27px">Hiển thị từ 1 đến <%=numberOfPage %> của <%=numberOfItem %> danh mục</div>
                                </div>
                                <div class="col-sm-6" style="text-align: right;">
